<?php
    $this -> load -> view('v1/init/header', array('toolbar' => 'Crear Contacto'));
    $this -> load -> view('v1/alumno/nav_slide');
    $this -> load -> view('v1/alumno/nav_bar', array('nav_params' => array('toolbar' => 'Crear Contacto', 'nav_action' => 'menu', 'nav_icon' => 'menu', 'nav_href' => '')));
?>
                ...
                <div class="card">
                    <div class="card-content ">
                        ...
                        <div class="row" style="padding: 10px;">
                            ...
                            <?php
                                echo form_open('v1/alumno/AlumnoController/saveRegister');
                            ?>
